...
export const ITEMS: CatalogItem[] = [
  ...
  { id: 'dr-infusion-verveine', cat: 'drinks', station: 'bar', sub: 'Thés & Infusions', name: 'Infusion Verveine', price: 25, image: '/images/infusion-verveine.webp' },
  { id: 'dr-the-curcuma', cat: 'drinks', station: 'bar', sub: 'Thés & Infusions', name: 'Thé Curcuma', price: 30, image: '/images/the-curcuma.webp' },
  { id: 'dr-the-noir-assam', cat: 'drinks', station: 'bar', sub: 'Thés & Infusions', name: 'Thé Noir Assam', price: 30, image: '/images/the-noir-assam.webp' },
  { id: 'dr-rooibos', cat: 'drinks', station: 'bar', sub: 'Thés & Infusions', name: 'Rooibos', price: 30, image: '/images/rooibos.webp' },

  // ---- Boissons — Jus & Mocktails ----
  { id: 'dr-orange-pressee', cat: 'drinks', station: 'bar', sub: 'Jus & Mocktails', name: 'Orange Pressée', price: 30, image: '/images/orange-pressee.webp' },
  { id: 'dr-citron-presse', cat: 'drinks', station: 'bar', sub: 'Jus & Mocktails', name: 'Citron Pressé', price: 30, image: '/images/citron-presse.webp' },
  { id: 'dr-avocat', cat: 'drinks', station: 'bar', sub: 'Jus & Mocktails', name: 'Avocat', price: 40, image: '/images/avocat.webp' },
  { id: 'dr-avocat-fruits-secs', cat: 'drinks', station: 'bar', sub: 'Jus & Mocktails', name: 'Avocat & Fruits Secs', price: 45, image: '/images/avocat-fruits-secs.webp' },
  { id: 'dr-citron-gingembre', cat: 'drinks', station: 'bar', sub: 'Jus & Mocktails', name: 'Citron & Gingembre', price: 35, image: '/images/citron-gingembre.webp' },
  { id: 'dr-mojito', cat: 'drinks', station: 'bar', sub: 'Jus & Mocktails', name: 'Mojito Classique', price: 40, image: '/images/mojito.webp' },
  { id: 'dr-sunrise', cat: 'drinks', station: 'bar', sub: 'Jus & Mocktails', name: 'Sunrise', price: 45, image: '/images/sunrise.webp' },
  { id: 'dr-red-mood', cat: 'drinks', station: 'bar', sub: 'Jus & Mocktails', name: 'Red Mood', price: 45, image: '/images/red-mood.webp' },
  { id: 'dr-blue-mood', cat: 'drinks', station: 'bar', sub: 'Jus & Mocktails', name: 'Blue Mood', price: 45, image: '/images/blue-mood.webp' },

  // ---- Boissons — Frappés & Glacés ----
  { id: 'dr-milkshake-vanille', cat: 'drinks', station: 'bar', sub: 'Frappés & Glacés', name: 'Milk Shake Vanille', price: 45, image: '/images/milkshake-vanille.webp' },
  { id: 'dr-milkshake-chocolat', cat: 'drinks', station: 'bar', sub: 'Frappés & Glacés', name: 'Milk Shake Chocolat', price: 45, image: '/images/milkshake-chocolat.webp' },
  { id: 'dr-milkshake-caramel', cat: 'drinks', station: 'bar', sub: 'Frappés & Glacés', name: 'Milk Shake Caramel', price: 45, image: '/images/milkshake-caramel.webp' },
  { id: 'dr-milkshake-fraise', cat: 'drinks', station: 'bar', sub: 'Frappés & Glacés', name: 'Milk Shake Fraise', price: 45, image: '/images/milkshake-fraise.webp' },
  { id: 'dr-milkshake-banane', cat: 'drinks', station: 'bar', sub: 'Frappés & Glacés', name: 'Milk Shake Banane', price: 45, image: '/images/milkshake-banane.webp' },
  { id: 'dr-frappe-cafe', cat: 'drinks', station: 'bar', sub: 'Frappés & Glacés', name: 'Frappé Café', price: 50, image: '/images/frappe-cafe.webp' },
  ...
  { id: 'dr-iced-americano', cat: 'drinks', station: 'bar', sub: 'Frappés & Glacés', name: 'Iced Americano', price: 30, image: '/images/iced-americano.webp' },
  { id: 'dr-iced-latte', cat: 'drinks', station: 'bar', sub: 'Frappés & Glacés', name: 'Iced Latte', price: 35, image: '/images/iced-latte.webp' },
  { id: 'dr-iced-caramel', cat: 'drinks', station: 'bar', sub: 'Frappés & Glacés', name: 'Iced Caramel Macchiato', price: 40, image: '/images/iced-caramel.webp' },
  { id: 'dr-iced-mocha', cat: 'drinks', station: 'bar', sub: 'Frappés & Glacés', name: 'Iced Mocha Latte', price: 40, image: '/images/iced-mocha.webp' },
  { id: 'dr-iced-chocolat', cat: 'drinks', station: 'bar', sub: 'Frappés & Glacés', name: 'Iced Chocolat', price: 40, image: '/images/iced-chocolat.webp' },

  // ---- Pâtisserie — Éclairs ----
  { id: 'pa-eclair-vanille', cat: 'patisserie', station: 'cuisine', sub: 'Éclairs', name: 'Éclair Vanille', price: 28, image: '/images/eclair-vanille.webp' },
  { id: 'pa-eclair-cafe', cat: 'patisserie', station: 'cuisine', sub: 'Éclairs', name: 'Éclair Café', price: 28, image: '/images/eclair-cafe.webp' },
  { id: 'pa-eclair-chocolat', cat: 'patisserie', station: 'cuisine', sub: 'Éclairs', name: 'Éclair Chocolat', price: 28, image: '/images/eclair-chocolat.webp' },
  { id: 'pa-eclair-noisette', cat: 'patisserie', station: 'cuisine', sub: 'Éclairs', name: 'Éclair Noisette', price: 38, image: '/images/eclair-noisette.webp' },
  { id: 'pa-eclair-pistache', cat: 'patisserie', station: 'cuisine', sub: 'Éclairs', name: 'Éclair Pistache', price: 38, image: '/images/eclair-pistache.webp' },
  { id: 'pa-eclair-framboise', cat: 'patisserie', station: 'cuisine', sub: 'Éclairs', name: 'Éclair Framboise', price: 38, image: '/images/eclair-framboise.webp' },
  { id: 'pa-eclair-citron', cat: 'patisserie', station: 'cuisine', sub: 'Éclairs', name: 'Éclair Citron', price: 38, image: '/images/eclair-citron.webp' },
  { id: 'pa-eclair-mangue', cat: 'patisserie', station: 'cuisine', sub: 'Éclairs', name: 'Éclair Mangue', price: 38, image: '/images/eclair-mangue.webp' },
  { id: 'pa-eclair-tiramisu', cat: 'patisserie', station: 'cuisine', sub: 'Éclairs', name: 'Éclair Tiramisu', price: 38, image: '/images/eclair-tiramisu.webp' },
